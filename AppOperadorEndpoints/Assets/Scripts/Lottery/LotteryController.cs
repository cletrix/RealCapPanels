...
public class LotteryController : MonoBehaviour
{
    ...
    public void ShowTicketLottery()
    {
        ...
        ticketController.PopulateTicketInfos(
            ...
            GameManager.instance.lotteryResultScriptable.ganhadorContemplado.endereco,
            GameManager.instance.lotteryResultScriptable.ganhadorContemplado.numero,
            GameManager.instance.lotteryResultScriptable.ganhadorContemplado.complemento,
            ...
            GameManager.instance.lotteryResultScriptable.ganhadorContemplado.cep,

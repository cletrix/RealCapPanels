...
public class BarcodeCam : MonoBehaviour
{
    ...
    // void OnGUI()
    // {
    //     GUI.DrawTexture(screenRect, encoded, ScaleMode.ScaleToFit);
    // }
    ...
    void Start()
    {
        ...
        // screenRect = new Rect(showQRcode.rectTransform.position.x, showQRcode.rectTransform.position.y, Screen.width / 4, Screen.height / 4);
        showQRcode.texture = encoded;
